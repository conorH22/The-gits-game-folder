...
bool Level4SplashScene::init()
{
	...
	auto ContinueGame = MenuItemImage::create("continue.png", "continue.png", CC_CALLBACK_1(Level4SplashScene::GoToLevel4Scene, this));
...
void Level4SplashScene::GoToLevel4Scene(Ref *sender)
{
